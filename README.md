...
The website (https://maastrichtuniversitypress.github.io/Thirst-for-Justice-The-International-Court-of-Justice/) is created using the [TeachBooks](https://teachbooks.io/). To recreate it you have two options (more information in the [TeachBooks manual](https://teachbooks.io/manual/):
